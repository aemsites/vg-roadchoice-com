...
const subTitleText = getTextLabel('search-results:no_results_subtitle');
const needHelp = getTextLabel('search-results:no_results_need_help');
const contactUsText = getTextLabel('search-results:no_results_contact_us');
