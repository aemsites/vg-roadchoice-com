...
const formContent = `
  <div class="v2-forms__floating-label-group">
    ...
    <label for="subscribe-email" class="v2-forms__floating-label">${getTextLabel('v2_forms:subscribe_email_label')}</label>
    <input type="hidden" id="form-locale" name="form-locale" value="${getLocale()}" />
  </div>
  <button class="button button--primary" type="submit">${getTextLabel('v2_forms:button_submit')}</button>
`;
